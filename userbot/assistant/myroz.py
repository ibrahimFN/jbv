...
# Telegram  :  @PP3_3   -  https://github.com/JMTHON-AR/JM-THON/blob/master/LICENSE
...
async def start(event):
    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [
                    Button.url("• المطـور •", "https://t.me/PP3_3"),
        ...
        await tgbot.send_message(
            ...
            buttons=[
                ...
                [Button.url("• المساعدة  •", "https://t.me/GroupJmthon")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("شرح التنصيب 📺", "غير متوفر حاليا الشرح")],
                [Button.url("للاستفسار ❓", "https://t.me/PP3_3")],
            ],
        )
